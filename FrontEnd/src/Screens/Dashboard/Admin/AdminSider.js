        ...
        <li className="nav-item">
          ...
          >
            <div style={{ display: "flex", alignItems: "center" }}>
              ...
              <span style={{color:"white"}}>Add Projects</span>
            </div>
          </a>
        </li>
        ...
        <li className="nav-item">
          ...
          >
            <div style={{ display: "flex", alignItems: "center" }}>
              ...
              <span style={{color:"white"}}>Add Managers</span>
            </div>
          </a>
        </li>
        ...
        <li className="nav-item">
          ...
          >
            <div style={{ display: "flex", alignItems: "center" }}>
              ...
              <span style={{color:"white"}}>View Managers</span>
            </div>
          </a>
        </li>
        <li className="nav-item">
          ...
          >
            ...
            speaker_notes
              ...
              <span style={{color:"white"}}>View Messages</span>
            </div>
          </a>
        </li>
      </ul>
